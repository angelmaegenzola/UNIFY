<?php
// ============================================================
//  UNIFY — officer_messages_controller.php  (REWRITTEN)
//  Matches student_messages_controller.php exactly.
// ============================================================
...
$userFirst = $_SESSION['first_name'] ?? 'User';
...
if ($requestedClubId > 0) {
    foreach ($allClubs as $c) {
        if ((int) $c['club_id'] === $requestedClubId) { $officerClub = $c; break; }
    }
}
if (!$officerClub) $officerClub = $allClubs[0];
...
$isMod       = in_array($officerRole, ['officer', 'lead', 'president', 'vice president']);

// ── DM: resolve target user ────────────────────────────────
