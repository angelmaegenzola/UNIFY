<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/UNIFY(db)/app/controllers/adminprofile_controller.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  ...
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/adminprofile.css" />
...
<script src="/UNIFY(db)/public/assets/javascripts/adminprofile.js"></script>
</body>
</html>