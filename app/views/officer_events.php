<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/UNIFY(db)/app/controllers/officer_events_controller.php'; ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/officer_events.css" />
...
══════════════════════════════════════════ -->
  ...
  <script src="/UNIFY(db)/public/assets/javascripts/jsQR.min.js"></script>
  <script src="/UNIFY(db)/public/assets/javascripts/officer_events.js"></script>
