<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/UNIFY(db)/app/controllers/verify_2fa_controller.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
  ...
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/verify_2fa.css">
</head>
<body>
...
<script src="/UNIFY(db)/public/assets/javascripts/verify_2fa.js"></script>
