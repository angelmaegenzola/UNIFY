<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/UNIFY(db)/app/controllers/clubpage_controller.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
  ...
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/clubpage.css"/>
