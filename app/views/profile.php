<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/UNIFY(db)/app/controllers/profile_controller.php'; ?>
<?php
// ── Fallback defaults ──────────────────────────────────────────────────────
$user = $user ?? [];
...
<head>
  ...
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/profile.css" />
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/setup_2fa.css" />
</head>
...
<div class="sidebar-club-badge">
  ...
  <script src="/UNIFY(db)/public/assets/javascripts/setup_2fa.js"></script>
