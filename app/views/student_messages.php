<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/UNIFY(db)/app/controllers/student_messages_controller.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  ...
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/studentevents.css" />
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/student_messages.css" />
</head>
<body>
<div class="app">
      ...
      <div class="sidebar-profile">
        ...
        <a href="index.php?page=studentprofile" class="profile-link">
          <div class="profile-info">
            ...
            <span class="profile-role"><?= ucfirst(htmlspecialchars($studentRole)) ?></span>
          </div>
        </a>
    ...
    <header class="topbar">
      ...
      <div class="topbar-actions">
        <div class="student-tag">
          ...
          <?= ucfirst(htmlspecialchars($studentRole)) ?> · <?= htmlspecialchars($clubName) ?>
        </div>
        ...
        <a href="index.php?page=studentprofile" class="topbar-profile">
          ...
          <div class="topbar-profile-info">
            ...
            <span class="tp-role"><?= ucfirst(htmlspecialchars($studentRole)) ?></span>
          </div>
        </a>
      </div>
    </header>
          ...
          <div class="msg-sidebar-header">
            <?php if (count($allClubs) > 1): ?>
              <div class="msg-club-switcher" id="clubSwitcher">
                <button class="msg-club-switcher-btn" onclick="SM.toggleClubSwitcher(event)">
                  <div class="msg-club-logo-wrap">
                    <?php if (!empty($studentClub['logo_path'])): ?>
                      <img src="<?= htmlspecialchars($studentClub['logo_path']) ?>" alt="" class="msg-club-logo" />
                    <?php else: ?>
                ...
                <div class="msg-club-dropdown">
                  ...
                  ?>
                  <a href="index.php?page=student_messages&club_id=<?= (int)$c['club_id'] ?>"
            ...
            <div class="msg-member-list" id="msgMemberList" style="overflow-y:auto;flex:1;min-height:0;">
              <?php
                ...
                foreach ($dbMembers as $i => $m):
                  if ((int)$m['user_id'] === $userId) continue; // skip self
                  $color    = $colors[$i % 5];
          ...
          <div class="msg-input-area">
            <div class="msg-input-wrap">
              ...
              <div class="msg-input-actions">
                ...
                <button class="msg-send-btn" onclick="SM.sendMessage()" title="Send (Enter)">
...
<div class="msg-delete-overlay" id="msgDeleteModal">
  <div class="msg-delete-box">
    ...
    <div class="msg-del-actions">
      <button class="msg-del-cancel" onclick="SM.closeDeleteModal()">Cancel</button>
...
<script src="/UNIFY(db)/public/assets/javascripts/student_messages.js"></script>
</body>
</html>