<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/UNIFY(db)/app/controllers/status_controller.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
  ...
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/status.css"/>
</head>
<body>
<div class="app">
...
<script src="/UNIFY(db)/public/assets/javascripts/status.js"></script>
