<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/UNIFY(db)/app/controllers/officer_explore_controller.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  ...
  <link rel="stylesheet" href="/UNIFY(db)/public/assets/css/officer_explore.css" />
...
<script src="/UNIFY(db)/public/assets/javascripts/officer_explore.js"></script>
</body>
</html>